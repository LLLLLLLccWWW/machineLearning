...
results = {}
with pd.ExcelWriter('Model_Evaluation_Results.csv', engine='csvwriter') as writer:
    for name, model in models.items():
        ...
        df_metrics.to_csv(writer, sheet_name=f'{sheet_base_name}_Metrics')
        ...
        df_conf_matrix.to_csv(writer, sheet_name=safe_sheet_name(name, "_ConfMatrix"))
        ...
        df_labels_names.to_csv(writer, sheet_name=safe_sheet_name(name, "_PredLabels"))
